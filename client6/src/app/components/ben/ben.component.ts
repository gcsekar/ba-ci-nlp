...
export class BenComponent implements OnInit {
  ...
  setFocus(){
    this.questionTextCtrl.nativeElement.focus();
  ...
  PopupCenter(url, title, w, h) {
    ...
    var dualScreenLeft = window.screenLeft != undefined ? window.screenLeft : 0;  //(window.screenLeft < 0 ? 0 : window.screenLeft)
    var dualScreenTop = window.screenTop  != undefined ? (window.screenTop < 0 ? 0: window.screenTop) : 0;
